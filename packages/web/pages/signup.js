          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div>
              ...
              <input
                ...
                {...register("name")}
              />
              {message != null && message.path == "name" && (
                <p className="text-red-500 text-sm -mt-3">{message.message}</p>
              )}
            </div>
            <div>
              ...
              <input
                ...
                {...register("email")}
              />
              {message != null && message.path == "email" && (
                <p className="text-red-500 text-sm -mt-3">{message.message}</p>
              )}
            </div>
            <div>
              ...
              <div className="flex items-center">
                ...
                />
                <button
                  className="absolute mb-4 ml-52 flex items-center pl-2"
                  onClick="handleEye()"
                >
                  {showPass ? (
                    <EyeIcon className="h-4 w-4 mr-2 text-gray-700" />
                  ) : (
                    <EyeOffIcon className="h-4 w-4 mr-2 text-gray-700" />
                  )}
                </button>
              </div>
              {message != null && message.path == "password" && (
                <p className="text-red-500 text-sm -mt-3">{message.message}</p>
              )}
            </div>
            ...
            {message != null && message.path == "Submit" && (
            ...
            <div>
              <p className="text-center text-sm text-primary mt-4">
                ...
                <button
                  ...
                  className="text-primary ml-2 text-border-indigo-500"
                >
                  Sign In
                </button>
              </p>
